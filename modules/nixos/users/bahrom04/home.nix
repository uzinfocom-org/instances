{
  ...
  imports = [
    inputs.bahrom04.homeModules.git
    inputs.bahrom04.homeModules.zsh
    inputs.bahrom04.homeModules.helix
    inputs.bahrom04.homeModules.topgrade
    inputs.bahrom04.homeModules.packages
    inputs.bahrom04.homeModules.fastfetch
  ];
